...
public enum CommonLedgerError implements ScalarDlError {
  ...
  REQUEST_SIGNATURE_VALIDATION_FAILED(
      StatusCode.INVALID_SIGNATURE, "001", "The request signature can't be validated.", "", "Verify that the certificate used to sign the request is registered and valid."),
  ...
  //
  FUNCTION_NOT_FOUND(
      StatusCode.FUNCTION_NOT_FOUND, "001", "The specified function is not found.", "", "Register the function first before attempting to execute it."),

  //
  // Errors for UNLOADABLE_FUNCTION(411)
  //
  LOADING_FUNCTION_FAILED(
      StatusCode.UNLOADABLE_FUNCTION, "001", "Loading the function failed. Details: %s", "", "Check the error details and verify that the function class is valid and accessible."),

  //
  // Errors for RUNTIME_ERROR(502)
  //
  UNSUPPORTED_FUNCTION(
      StatusCode.RUNTIME_ERROR, "001", "The function type or instance is not supported.", "", "Check the error details in the logs and verify that the function type is supported."),
  ;
