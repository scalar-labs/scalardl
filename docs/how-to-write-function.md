...
Note that the return value can be null if nothing has been set by Contracts and the return value type `T` will be decided based on a base Function class that you use.
