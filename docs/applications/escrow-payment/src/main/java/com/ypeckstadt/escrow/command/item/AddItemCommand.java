...
public class AddItemCommand extends LedgerClientExecutor implements Callable {
    ...
    @CommandLine.Option(names = {"-id", "--id"}, paramLabel = "ID", description = "item id", required = true)
    String itemId;

    @CommandLine.Option(names = {"-n", "--name"}, paramLabel = "NAME", description = "item name", required = true)
    String name;

    @CommandLine.Option(names = {"-p", "--price"}, paramLabel = "PRICE", description = "item price", required = true)
    int price;

    @CommandLine.Option(names = {"-s", "--seller"}, paramLabel = "SELLER", description = "seller's account id", required = true)
    String seller;
