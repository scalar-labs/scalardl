...
public class Constants {
    ...
    public static final String CONTRACT_ADD_ACCOUNT_MISSING_ARGUMENTS_ERROR = "wrong or missing arguments to create an account";
    public static final String CONTRACT_ADD_ACCOUNT_DUPLICATE_ERROR = "an account with this id already exists";
}
