...
public class AddOrder extends Contract {
  ...
  public JsonObject invoke(Ledger ledger, JsonObject argument, Optional<JsonObject> properties) {
    ...
    // Debit escrow and credit are split into 2 separate contracts to not make the contract to heavy
    // and test calling external contracts.
    // In a normal situation both actions will always follow each other so it makes more sense to
    // put it into one contract
